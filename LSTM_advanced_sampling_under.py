...
if __name__ == '__main__':
    ...
    x_train, y_train, x_test_val, y_test_val = prepare_grouped_data_under(scale=True)
    ...
    for hidden_dimension in [50, 100, 200]:
        ...
        best_accuacy, best_dimension = (accuracy, hidden_dimension) if accuracy > best_accuracy else (best_accuracy, best_dimension)

    print(f'beast accuracy: {best_accuacy}\tBest dim: {best_dimension}')
